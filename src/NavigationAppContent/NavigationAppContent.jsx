...
class NavigationAppContent extends PureComponent {
  ...
  handleAddRoleClick() {
    document.querySelector('.FlyoutDrawer-container').classList.remove('animation-fadeOutRight');
    document.querySelector('.FlyoutDrawer-container').classList.add('animation-fadeInRight');
    document.querySelector('.FlyoutDrawerWrapper').classList.remove('HiddeBackground');
  }
            ...
            <div className='Pod-pod NewsAndEvents-newsAndEventsPodContainer'>
              <Tabs>
                ...
                <TabPanel>
                  ...
                  <section className='Toolbar'>
                    <button onClick={this.handleAddRoleClick}>Add Role</button>
                    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
